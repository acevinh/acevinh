...
| | |
| --- | --- |
| 🛒 **[Omega Google & Facebook Feed](https://apps.shopify.com/google-shopping-feed-pro)** | **Day job — the product, not a side project.** A published Shopify app, live since 2020, **4.9★ from 110 reviews**. I'm a developer on it and have been since my internship: feature work, refactors, and day-to-day development across the NestJS API and the React admin UI. Closed source; the link goes to the App Store listing. |
...
**Platform** — `Docker` `Shopify Admin GraphQL` `Google Merchant Center` `Meta Catalog`
